 ...
 */
	protected function _parseOptions($options) {
		...
		if (isset($options['class'])) {
			$formInput = $this->_View->Theme->getCssClass('formInput');
 ...
 */
	protected function _parseOptionsAddon($options) {
		...
		if (isset($this->_addon)) {
			$options['class'] = $this->_View->Theme->getCssClass('formInput');
			if (isset($options['append'])) {
				$options['between'] = '<div class="'.$this->_View->Theme->getCssClass('addonClass').'">';
