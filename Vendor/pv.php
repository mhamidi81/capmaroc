...
class PV  extends TCPDF { 
    ...
    */ 
    ...
    { 
        ...
        $this->Image($trone_image, 143,5, 60,30, 'JPG', '', 'L', false, 200, '', false, false, 0, false, false, false);
    ...
    */ 
    ...
    { 
        ...
        $this->Image($footer_image, 5, $this->GetY()-5, 200,25, 'PNG', '', 'L', false, 200, '', false, false, 0, false, false, false);
    } 
} ?>